<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="concact.aspx.cs" Inherits="South___Real_Estate_Company.concact" %>
                    ...
                    <div class="contact-form">
                        <form action="#" method="post">
                            <div class="form-group">
                                <asp:TextBox ID="tname" runat="server" class="form-control" placeholder="Your Name"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="tphone" runat="server" class="form-control" placeholder="Your Phone"></asp:TextBox>
                                
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="temail" runat="server" class="form-control" placeholder="Your Email" TextMode="Email"></asp:TextBox>
                                
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="tmessage" runat="server" class="form-control" placeholder="Your Message" Rows="10" TextMode="MultiLine" Columns="30"></asp:TextBox>
                                
                            </div>
                            
                            <asp:Button ID="sm" runat="server" Text="Send Messsage" class="btn south-btn" OnClick="sm_Click"/>
